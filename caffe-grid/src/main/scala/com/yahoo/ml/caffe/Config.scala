...
class Config() extends Serializable {
  ...
  def this(args: Array[String]) {
    ...
    val cmd: CommandLine = {
      ...
      options.addOption("container_memory", "container_memory", false, "container memory")
      options.addOption("container_vcores", "container_memory", false, "container vcores")
      options.addOption("num", "num", false, "container num")
      options.addOption("CAFFE_processor_jar", "CAFFE_processor_jar", false, "CAFFE_processor_jar num")
      options.addOption("cs", "cs", false, "cs")
      options.addOption("ti", "ti", false, "ti")
      options.addOption("addresses", "addresses", false, "addresses")

      options.addOption("feature", "feature", false, "feature")
    ...
    clusterSize = if (cmd.hasOption("clusterSize")) Integer.parseInt(cmd.getOptionValue("clusterSize")) else 1
