...
public class CaffeApplicationRpcServer implements CaffeCluster, Runnable {
    ...
    public CaffeApplicationRpcServer(String hostname, CaffeApplicationRpc rpc) {
    ...
    public void run() {
        ...
        this.server = rpc.getServer(
                CaffeCluster.class, this, address, conf, null,
